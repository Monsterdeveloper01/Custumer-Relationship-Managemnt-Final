...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
  ...
  $ditemukan_oleh = trim($_POST['ditemukan_oleh'] ?? $mid); // default diisi user login
      ...
      <form method="post" class="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <div class="col-span-2">
          ...
          <input type="email" name="email" value="<?= h($_POST['email'] ?? '') ?>"
            class="mt-1 w-full rounded-xl border-gray-300 shadow-sm focus:border-blue-500 
             focus:ring-2 focus:ring-blue-400 p-3 transition">
        </div>

        <!-- Secondary Email -->
        <div class="col-span-2">
          <label class="block text-sm font-semibold text-gray-700">Secondary Email</label>
          <input type="email" name="email_lain" value="<?= h($_POST['email_lain'] ?? '') ?>"
            class="mt-1 w-full rounded-xl border-gray-300 shadow-sm focus:border-blue-500 
             focus:ring-2 focus:ring-blue-400 p-3 transition">
        </div>
        ...
        <div>
          ...
          <input type="text" name="nama_perusahaan" value="<?= h($_POST['nama_perusahaan'] ?? '') ?>"
            class="mt-1 w-full rounded-xl border-gray-300 shadow-sm focus:border-blue-500 
             focus:ring-2 focus:ring-blue-400 p-3 transition">
        </div>
        ...
        <div>
          ...
          <input type="text" name="nama" value="<?= h($_POST['nama'] ?? '') ?>"
            class="mt-1 w-full rounded-xl border-gray-300 shadow-sm focus:border-blue-500 
             focus:ring-2 focus:ring-blue-400 p-3 transition">
        </div>
        ...
        <div>
          ...
          <input type="text" name="kategori_perusahaan" value="<?= h($_POST['kategori_perusahaan'] ?? '') ?>"
            class="mt-1 w-full rounded-xl border-gray-300 shadow-sm focus:border-blue-500 
             focus:ring-2 focus:ring-blue-400 p-3 transition">
        </div>
        ...
        <div>
          ...
          <input type="text" name="kategori_jabatan" value="<?= h($_POST['kategori_jabatan'] ?? '') ?>"
            class="mt-1 w-full rounded-xl border-gray-300 shadow-sm focus:border-blue-500 
             focus:ring-2 focus:ring-blue-400 p-3 transition">
        </div>
        ...
        <div>
          ...
          <input type="text" name="jabatan_lengkap" value="<?= h($_POST['jabatan_lengkap'] ?? '') ?>"
            class="mt-1 w-full rounded-xl border-gray-300 shadow-sm focus:border-blue-500 
             focus:ring-2 focus:ring-blue-400 p-3 transition">
        </div>
        ...
        <div>
          ...
          <input type="text" name="tipe" value="<?= h($_POST['tipe'] ?? '') ?>"
            class="mt-1 w-full rounded-xl border-gray-300 shadow-sm focus:border-blue-500 
             focus:ring-2 focus:ring-blue-400 p-3 transition">
        </div>
        ...
        <div>
          ...
          <input type="text" name="no_telp1" value="<?= h($_POST['no_telp1'] ?? '') ?>"
            class="mt-1 w-full rounded-xl border-gray-300 shadow-sm focus:border-blue-500 
             focus:ring-2 focus:ring-blue-400 p-3 transition">
        </div>
        ...
        <div>
          ...
          <input type="text" name="no_telp2" value="<?= h($_POST['no_telp2'] ?? '') ?>"
            class="mt-1 w-full rounded-xl border-gray-300 shadow-sm focus:border-blue-500 
             focus:ring-2 focus:ring-blue-400 p-3 transition">
        </div>
        ...
        <div class="col-span-2">
          ...
          <textarea name="alamat" rows="3"
            class="mt-1 w-full rounded-xl border-gray-300 shadow-sm focus:border-blue-500 
             focus:ring-2 focus:ring-blue-400 p-3 transition"><?= h($_POST['alamat'] ?? '') ?></textarea>
        </div>

        <!-- City -->
        <div>
          <label class="block text-sm font-semibold text-gray-700">City</label>
          <input type="text" name="kota" value="<?= h($_POST['kota'] ?? '') ?>"
            class="mt-1 w-full rounded-xl border-gray-300 shadow-sm focus:border-blue-500 
             focus:ring-2 focus:ring-blue-400 p-3 transition">
        </div>
